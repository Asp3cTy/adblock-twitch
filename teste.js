                ...
                if (url.endsWith('m3u8')) {
                    ...
                    if (OPT_MODE_STRIP_AD_SEGMENTS) {
                        return new Promise(async function(resolve, reject) {
                            ...
                            if (streamInfo != null && streamInfo.Encodings != null && (await realFetch(streamInfo.Encodings.match(/^https:.*\.m3u8$/m)[4])).status !== 200) {
                                    ...
                                    if (encodingsM3u8Response != null && encodingsM3u8Response.status === 200) {
                                        ...
                                        if (i == 0) {
                                            ...
                                            if (lowResBestUrl != null && streamInfo.Encodings != null) {
                                                ...
                                                for (var j = 0; j < normalLines.length - 5; j++) {
